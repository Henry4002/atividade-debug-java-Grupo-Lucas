...
System.out.print("Escolha pedra, papel ou tesoura: ");
        ...
        System.out.println("Computador escolheu: " + computador);if (jogador.equals(computador)) {
            System.out.println("Empate!");
        } else if ((jogador.equals("pedra") && computador.equals("tesoura"))
        (jogador.equals("papel") && computador.equals("pedra")) (jogador.equals("tesoura") && computador.equals("papel"))
        ) {
